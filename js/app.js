...
const TRANSLATIONS = {
  ar: {
    ...
    teacherSchool: 'مدرسة محمد بن حمد الشرقي للحلقة الثانية - بنين',
    teacherName: '—',
  ...
  en: {
    ...
    teacherSchool: 'Mohamed Bin Hamad Al Sharqi School - Cycle 2 (Boys)',
    teacherName: '—',
