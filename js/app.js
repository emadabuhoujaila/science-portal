...
function applyGlobalLang(){
  ...
  if(parentBanner) parentBanner.alt = isAr ? 'بوابة المتابعة' : 'Follow-up Portal';
...
function renderParentSubjectTabs(cls, studentName, mid, teachersList, section){
  ...
  document.getElementById('parent-body').innerHTML = `
    <img src="img/portal-banner.png" alt="بوابة المتابعة" class="parent-banner" id="parent-banner">
